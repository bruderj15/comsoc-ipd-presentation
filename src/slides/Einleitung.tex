...
\begin{frame}{Beispiel}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Beide sagen aus: jeweils 20 Jahre
        \end{itemize}
...
\begin{frame}{Motivation}
    \begin{itemize}
        ...
        \item Beide Verdächtige wissen vom zeitgleichen Verhör
        ...
        \item \textbf{Das Verhör ist also fair? Beide sind ja vollständig isoliert, oder?}
        \item \textbf{Welche Wahl ist die Beste aus Sicht eines Verdächtigen?}
        \item \textbf{Was passiert, wenn wiederholt gegeneinander ausgesagt werden kann?}
    \end{itemize}
\end{frame}

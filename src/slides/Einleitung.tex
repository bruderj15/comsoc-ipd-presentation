...
\begin{frame}{Motivation}
    \begin{itemize}
        ...
        \item Anwendung besonders in evolutionärer Biologie: Symbionten, Parasiten, Altruismus, Nepotismus \parencite{axelrod-hamilton-1981}
        \item Aber auch Ökonomie: Preisabsprachen, Verhandlungen, Partnerschaften \parencite{honhon-hyndman-2020}
    \end{itemize}
\end{frame}

...
\begin{frame}{Motivation: Anwendung}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Aber: Meist in oder zwischen Populationen \parencite{hilbe-nowak-sigmund-2013}, hier nur zwischen zwei Individuen
        \end{itemize}
        ...
        \end{itemize}
        \item In der HTWK: Partnerarbeiten
    \end{itemize}
\end{frame}

\begin{frame}{Wiederholung: Nash-Equilibrium}
    \begin{itemize}
        \item Jeder Spieler $p_i \in P, i \in \mathbb{N}$ spielt eine Strategie $s_{p_i}$ \parencite{kreps-1989}
        \item Strategieprofil $\left( s_{p_i}, \ldots, s_{p_n} \right)$ ist n-Tupel der Strategien aller $n \in \mathbb{N}_{\geq 2}$ Spieler
        \item Strategieprofil bildet \textbf{Nash-Equilibrium} genau dann, wenn kein Spieler durch alleiniges Ändern seiner Strategie einen Vorteil erhalten würde

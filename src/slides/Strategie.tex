...
\begin{frame}{Markov-Kette}
    \begin{itemize}
        ...
        \item Daher: Markov-Kette ist homogen: $ \forall r, r\prime \in \mathbb{N}^+_{< n}, \. \forall z_1, z_2 \in Z: \bigl( X_{r + 1} = z_2 \,\big|\, X_r = z_1 \bigr) = \bigl( X_{r\prime + 1} = z_2 \,\big|\, X_{r\prime} = z_1 \bigr)$
    \end{itemize}
\end{frame}

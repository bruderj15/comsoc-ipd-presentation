...
\begin{frame}{Modellierung (PD)}
    \begin{itemize}
        ...
        \item Vier abstrakte Kenngrößen (Konfiguration):
        \begin{itemize}
        ...
        \end{itemize}
        \item Es gilt: $T > R > P > S \land 2R > T + S$, erzeugt Auszahlungsmatrix (Tafel) \cite{axelrod-hamilton-1981}
    \end{itemize}
\end{frame}
...
\begin{frame}{Modellierung: Erweiterung um Iterationen (IPD)}
    \begin{itemize}
        ...
        $\Rightarrow$ wir betrachten große $n$ $\Rightarrow$ \textit{scheinbar} unendlich
        \item Warum? Wenn $n$ bekannt: Nash-Equilibrium bei $w(\_) = D$ (Induktion, Tafel) \cite{press-dyson-2012}
    \end{itemize}
\end{frame}